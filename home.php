...
$jurusan = mysqli_query($koneksi, "SELECT * FROM data_jurusan");
$total_jurusan = mysqli_num_rows($jurusan);
$laki = mysqli_query($koneksi, "SELECT * FROM data_mahasiswa where jenis_kelamin ='Laki-Laki'");
$perempuan = mysqli_query($koneksi, "SELECT * FROM data_mahasiswa where jenis_kelamin ='Perempuan'");
											...
											<div class="card-body">
												<div class="media align-items-center">
													...
													<div class="media-body">
														...
														<span class="title text-black font-w600"><?= mysqli_num_rows($laki);?> <span>/</span> <?=mysqli_num_rows($perempuan);?></span>
													</div>
												</div>
												<div class="progress" style="height:5px;">
								...
								<div class="row">
									<div class="col-12">
										<div class="table-responsive">
											...
											<td>
												<?php $jum_mahasiswa = mysqli_query($koneksi, "SELECT id_mhs from data_mahasiswa where id_jurusan = '$get[id_jurusan]'") ?>
												<?= mysqli_num_rows($jum_mahasiswa) ?>
											</td>
											</tr>
									<?php endforeach; ?>
												</tbody>
